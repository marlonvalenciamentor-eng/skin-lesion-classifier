...
|---|-------------------------------|--------------------------|-----------------------------------|:------:|
| 1 | **Mapa Mental 1: Arquitectura y UI** | Jerarquía visual clara, estación Streamlit, patrón Fachada, modelo ViT y XAI Grad-CAM. | Archivos PDF/HTML en `Material Clase2/Mapas_Mentales/Entregas/` (Entrega Moodle) | ✅ **CUMPLIDO** |
| 2 | **Mapa Mental 2: Pipeline y Despliegue** | Relación del flujo de datos vs despliegue operativo de software, prevención y mitigación de bugs. | Archivos PDF/HTML en `Material Clase2/Mapas_Mentales/Entregas/` (Entrega Moodle) | ✅ **CUMPLIDO** |
